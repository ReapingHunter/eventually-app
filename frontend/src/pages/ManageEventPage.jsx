...
import { FunnelIcon, QueueListIcon as QueueListIconSolid, Squares2X2Icon as Squares2x2IconSolid, ViewColumnsIcon as ViewColumnsIconSolid, PlusIcon } from "@heroicons/react/24/solid";
        ...
        <div className="px-32 justify-center items-center">
          <div className="w-full border-b justify-between border-gray-300 flex">
            ...
            <div className="space-x-2">
              <button className="p-2 rounded-lg bg-transparent transition" onClick={()=>setViewMode("carousel")}>
                {viewMode === "carousel" ? <ViewColumnsIconSolid className="w-6 h-6 text-[#000000]"/> 
                                         : <ViewColumnsIconOutline className="w-6 h-6 text-[#000000]"/>} 
              </button>
              <button className="p-2 rounded-lg bg-transparent transition" onClick={()=>setViewMode("grid")}>
                {viewMode === "grid" ? <Squares2x2IconSolid className="w-6 h-6 text-[#000000]"/> 
                                     : <Squares2x2IconOutline className="w-6 h-6 text-[#000000]"/>} 
              </button>
              <button className="p-2 rounded-lg bg-transparent transition" onClick={()=>setViewMode("list")}>
              {viewMode === "list" ? <QueueListIconSolid className="w-6 h-6 text-[#000000]"/> 
